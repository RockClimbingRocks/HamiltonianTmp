...
function GetMatrixRepresentationOfOperator(operator:: String, isSparse:: Bool, S:: Float64 = 1/2)
...
# """
function IndecesOfSubBlock(L:: Int64, N:: Int64 = Int(L÷2)):: Vector{Int64}
    S:: Float64 = 1/2;
...
# """
function WriteStateInFockSpace(index:: Int64, L:: Int64, S:: Float64):: Vector{Int64}
    state = zeros(Int64, L);
...
# - `S:: Float64=1/2`: e.
# """
function WriteStateInFockSpace!(index:: Int64, state::Vector{Int}, S:: Float64=1/2)
    digits!(state, index, base=Int(2*S+1));
end   
